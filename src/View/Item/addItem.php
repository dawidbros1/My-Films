...
<form class="px-4 py-3" action="./index.php?action=addItem" method="post">
    ...
    <div class="form-group">
        <label>Opis</label>
        <textarea class="form-control" rows="7" name="desctiption"><?php echo showSessionValue('memory:item:desctiption:value'); ?></textarea>
    </div>
