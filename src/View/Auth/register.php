...
<form class="px-4 py-3" action="./index.php?action=register" method="post">
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" name="password" id="exampleInputPassword1" value="<?php showSessionValue('register:password:value') ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" name="confirm_password" id="exampleInputPassword1" value="<?php showSessionValue('register:confirm_password:value') ?>">
    </div>
